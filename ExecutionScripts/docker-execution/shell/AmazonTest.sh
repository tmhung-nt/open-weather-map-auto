#!/bin/sh
workDir=$(pwd)
suite_path="Tests/AmazonTests.robot"
...
echo "sleep 10 seconds before executing"
sleep 10
...
robot -d ${reportDir}  --listener allure_robotframework  --log Regression_log.html --report Regression_report.html --output Regression.xml \
            -i Regression  -v BROWSER:gc  -v CUR_TEST_NAME:${test_suite_name}_Regression  ${suite_path}
